...
ui <- fluidPage(
  ...
  fluidRow(
    column(3, 
         textInput("term1", label = "Keyword 1", value="women")),
    column(3,
         textInput("term2", label = "Keyword 2", value="woman")),
    column(3,
         textInput("term3", label = "Keyword 3", value="girls")),
    column(3,
         textInput("term4", label = "Keyword 4", value="girl")),
